...
<title><fmt:message key="carro.titulo.exclusao"/></title>
</head>
...
<body>
	...
	<aside> <titulo>
	<h1>
		<marquee> <img src="resources/img/bandeira1.png"></img>EXCLUSÃO... 
	...
	<fundo_menu_escolha1> 
					...
					<h1 class="nivel-um"><fmt:message key="carro.titulo.exclusao"/></h1>
				
					<form action="../ExcluirCarro" method="post">
						<fieldset >
							...
							<p><input id="Excluir" type="submit" value="<fmt:message key="geral.excluir"/>" /></p>
						</fieldset>
					</form>
					<p>
